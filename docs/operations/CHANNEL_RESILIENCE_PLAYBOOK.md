...
5. If a backup bot is available, set `NEXT_PUBLIC_BACKUP_TELEGRAM`.
6. Redeploy and confirm `/start`, `/payment_session`, `/chat_id`, and admin delivery.
7. Update `/official` through env values before posting any public migration notice.
