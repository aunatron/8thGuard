export default function PaymentPolicyPage() {
  return (
    <main>
      ...
      <p>
        Stripe/Polar, Paystack/Others, and official crypto wallet payments are accepted only for 8thGuard digital review services.
      ...
      <p>
        Stripe/Polar and Paystack/Others may support card, bank transfer, Mobile Money, and other
        methods depending on region and availability. USD is the reference price; checkout rails may
      ...
      <h2>Verification</h2>
      <p>
        Users may be asked to provide a Stripe/Polar order reference, Paystack reference, crypto transaction hash, selected product,
